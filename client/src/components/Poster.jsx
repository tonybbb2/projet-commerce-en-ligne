            ...
            <div className='grid grid-cols-1 md:grid-cols-2 w-full md:w-3/4 mx-auto gap-10 py-10'>
                <div className='w-full  inline-block relative'>
                    ...
                    <div className='absolute bottom-5 md:bottom-20 left-8 md:left-16 py-2'>
                        ...
                        <button className="bg-slate-300 bg-opacity-60 hover:text-black hover:bg-white text-white h-[35px] w-[100px] text-[8px] md:text-[14px] md:h-[40px] md:w-[150px] font-extrabold py-2 px-6 rounded-full transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-110 duration-300 mt-2">
                            SHOP ALL
                        </button>
